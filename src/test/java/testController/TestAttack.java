...
public class TestAttack {
	...
	/**
	 * test verifies that a player eliminated discard 
	 * all his itemCard (e.g 1 sedatives, 2 adrenaline)
	 */
	@Test
	...
	/**
	 * test verifies that if an alien has not already moved,
	...
	/**
	 * test verifies that if an alien has  already attacked,
	...
	/**
	 * test verifies that if an alien has already moved and 
	 * has not already attacked, he can do action Attack
	 */
	@Test
