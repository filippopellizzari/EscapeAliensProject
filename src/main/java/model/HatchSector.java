...
public class HatchSector extends Sector {
	 ...
	 * 
	 * @param sectorType
	 *            , each type has particular rules
	 * @param closed
	 *            indicate if the sector is crossable by player
	 * @param x
	 *            use for indicate the letter of a sector
	 * @param y
	 *            use for indicate the number of a sector
	 * @param adjacent
	 *            list of adjacent sectors's coordinate
	 */
	...
	@Override
	public void addPlayer(Player player) { // a hatch sector close when a human
											// enters
