...
public class SelectSectorNoise implements TryToDoAnAction {
	...
	public String doAction(DTOTurn dtoTurn) {
		if(gameStatus.isMove()&&gameStatus.isNoiseInAnySector()&&dtoTurn.getCoordinate()!=null&&dtoTurn.getTypeCard()==null) {	//indica il settore del noise in any sector
			gameStatus.setNoiseInAnySector(true);
			return gameStatus.getPlayerPlay() +" : NOISE IN SECTOR "+dtoTurn.getCoordinate()+"\n";
		}
		else
