...
public class CardsCreator {
	...
	public SectorCards SectorCardsCreator() {
		...
		for(int i=0;i<6;i++) sectorCard.add(new SectorCard(false,TypeSectorCard.NoiseAny));
		for(int i=0;i<4;i++) sectorCard.add(new SectorCard(true,TypeSectorCard.NoiseYour));
		for(int i=0;i<6;i++) sectorCard.add(new SectorCard(false,TypeSectorCard.NoiseYour));
		for(int i=0;i<5;i++) sectorCard.add(new SectorCard(false,TypeSectorCard.Silence));
	...
	public ItemCards ItemCardsCreator() {
		...
		for(int i=0;i<2;i++) itemCard.add(new ItemCard(TypeItemCard.Attack));
		itemCard.add(new ItemCard(TypeItemCard.Defense));
		for(int i=0;i<3;i++) itemCard.add(new ItemCard(TypeItemCard.Sedatives));
		for(int i=0;i<2;i++) itemCard.add(new ItemCard(TypeItemCard.SpotLight));
		for(int i=0;i<2;i++) itemCard.add(new ItemCard(TypeItemCard.Teleport));
